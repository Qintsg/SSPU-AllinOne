...
提供全局当前学年、学期和周数设置，作为课表、成绩、考试、第二课堂等后续详情页的统一默认上下文。设置页支持自动切换开关、手动学年 / 学期 / 周数选择，并通过可复用 `AcademicTermSelector` 组件提供详情页学期切换入口。当前内置校历按已确认规则解析 2024 学年夏季后三周、2025 学年秋季、春季和夏季；未命中内置校历时明确提示并回退手动设置。
