...
设置页提供“学期设置”分区，可统一选择当前全局学期。周数由内置官网校历按周一自动计算；夏季学期按逐年教学段定位，中间非教学区间显示为暑假，其它空档显示为寒假。当前日期或所选学期超出 2023-2024 至 2026-2027 学年的内置定位范围时，应用会提示暂无日期定位，后续课表、成绩、考试等详情页应按不可定位状态降级处理。该设置是后续详情页复用的默认上下文，不会在当前版本中改变 EAMS 只读查询范围。
