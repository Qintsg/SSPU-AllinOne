...
## Idea
围绕 GitHub issue #132、#126、#127、#128、#107 建立一轮可长期演进的前端与本地安全能力完善计划。计划按优先级先处理 P0/P1 的信息中心微信推文重复 tag、公众号/服务号名称与 ID 展示、密码保护系统级快速验证，再推进 P2 的响应式布局与 Fluent 2 视觉统一。所有变更必须遵循 `CLAUDE.md`、仓库工作流、Flutter/Fluent 2 架构、本地隐私原则；本地插件/worktree 运行态配置仍需纳入 .gitignore 保护。
