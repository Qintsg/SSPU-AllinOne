...
OutputBaseFilename=SSPU-AllinOne-v{#AppVersion}-windows-arm64-setup
Compression=lzma
...
[Code]
const
  UninstallRegKey = 'Software\Microsoft\Windows\CurrentVersion\Uninstall\{F35768C5-7743-48E7-A7D0-F9923B7D1795}_is1';
