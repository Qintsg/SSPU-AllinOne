...
1. 本软件（工大聚合，英文名 SSPU-AllinOne）未获得上海第二工业大学（SSPU）、微信、微信公众平台及其关联方的任何官方授权、认可或背书。
...
1. 本软件采用 Artistic License 2.0 许可证开源。

2. 本软件中涉及的第三方商标、名称、标识（包括但不限于"上海第二工业大学"、"微信"、"微信公众平台"等）均为其各自所有者的财产，本软件对其不主张任何权利。
