...
extension _EmailPageLayout on _EmailPageState {
      ...
      children: [
        ...
        if (_canLoadMoreMessages) ...[
          ...
          Align(
            ...
            child: YhButton(
              key: const Key('email-load-more'),
              label: _isLoadingMoreMessages ? '正在加载' : '加载更早邮件',
              variant: YhButtonVariant.secondary,
              onTap: _isLoadingMoreMessages ? null : _loadMoreMessages,
            ),
          ),
        ],
      ],
  ...
  Widget _buildComposeCard(BuildContext context) {
    return EmailComposePanel(
      ...
      onSend: _sendEmail,
      attachments: _composeAttachments,
