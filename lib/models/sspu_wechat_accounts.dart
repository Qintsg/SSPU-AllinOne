...
const List<SspuWechatAccount> sspuWechatAccounts = [
  ...
  SspuWechatAccount(
    ...
    iconUrl: 'http://mmbiz.qpic.cn/mmbiz_png/qdWB7wH8tTpjV5H3S9ia43nXK9ttRGcyVNJPzRtpGZdQcMaLdvPtsted5lvyu79bNK7nlWzBC89KsicGPiaSRhXYw/0?wx_fmt=png',
    articleUrl: 'https://www.shanghai.gov.cn/',
  ),
  SspuWechatAccount(
    name: '上海市教育考试院',
    wxAccount: 'shmeea_fabu',
    iconUrl: 'http://mmbiz.qpic.cn/mmbiz_png/xvBgR37VHkyDgicicoQ6RGcN1DoNKoqsJdxahq0ThHIfXmQ9LZJCFtjzKQScNuEkw8I2WecF3w9LNwn6zPVjIp8Q/0?wx_fmt=png',
